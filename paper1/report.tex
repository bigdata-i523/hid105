...
\begin{abstract}
I discuss Big Data Analytics in ''other sports'' (not baseball) and how it is being used to improve and evaluate performance via visualization of 
\end{abstract}

\keywords{sports, analytics, data visualization, spatial rendering, HID105}
