...
\begin{document}
\title{Big Data in Sports Predtiction Models}
...
\begin{abstract}
We discuss Big Data Analytics in sports prediction analytics
\end{abstract}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=.5]{Neural network diagram.pdf}
